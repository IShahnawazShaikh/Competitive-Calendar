...
public class Atcoder extends Fragment implements RecyclerViewInterFace {
    View view;
    RecyclerView recyclerView;
    LinearLayoutManager manager;
    Adapter adapter;
    List<ContestBean> atcoder;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_atcoder, container, false);

        recyclerView=(RecyclerView) view.findViewById(R.id.atcoder_recycle);
        ...
        model.getAtcoder(getActivity()).observe(getActivity(), new Observer<List<ContestBean>>() {
            @Override
            public void onChanged(List<ContestBean> contestBeans) {
                progress_bar.setVisibility(View.INVISIBLE);
                atcoder= new ArrayList<ContestBean>(contestBeans);
                recyclerView.setLayoutManager(manager);
                adapter=new Adapter(contestBeans, Atcoder.this);
    ...
    public void onItemClicked(int position) {
        ...
        ContestBean obj=atcoder.get(position);
