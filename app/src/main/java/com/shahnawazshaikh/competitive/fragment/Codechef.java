...
public class Codechef extends Fragment implements RecyclerViewInterFace {
    View view;
    RecyclerView recyclerView;
    LinearLayoutManager manager;
    Adapter adapter;
    List<ContestBean> codechef;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView=(RecyclerView) view.findViewById(R.id.codechef_recycle);
        ...
        model.getCodechef(getActivity()).observe(getActivity(), new Observer<List<ContestBean>>() {
            @Override
            public void onChanged(List<ContestBean> contestBeans) {
                progress_bar.setVisibility(View.INVISIBLE);
                codechef= new ArrayList<ContestBean>(contestBeans);
                recyclerView.setLayoutManager(manager);
                adapter=new Adapter(contestBeans, Codechef.this);
    ...
    public void onItemClicked(int position) {
        ...
        ContestBean obj=codechef.get(position);
