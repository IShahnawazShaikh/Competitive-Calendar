...
public class HackerEarth extends Fragment  implements RecyclerViewInterFace {
   View view;
    RecyclerView recyclerView;
    LinearLayoutManager manager;
    Adapter adapter;
    List<ContestBean> hackerearth;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_hacker_earth, container, false);
        recyclerView=(RecyclerView) view.findViewById(R.id.hackerEarth_recycle);
        ...
        model.getHackerearth(getActivity()).observe(getActivity(), new Observer<List<ContestBean>>() {
            @Override
            public void onChanged(List<ContestBean> contestBeans) {
                progress_bar.setVisibility(View.INVISIBLE);
                hackerearth= new ArrayList<ContestBean>(contestBeans);
                recyclerView.setLayoutManager(manager);
                adapter=new Adapter(contestBeans, HackerEarth.this);
    ...
    public void onItemClicked(int position) {
        ...
        ContestBean obj=hackerearth.get(position);
