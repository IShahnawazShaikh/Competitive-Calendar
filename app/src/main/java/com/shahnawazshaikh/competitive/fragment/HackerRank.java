...
public class HackerRank extends Fragment implements RecyclerViewInterFace {
    View view;
    RecyclerView recyclerView;
    LinearLayoutManager manager;
    Adapter adapter;
    List<ContestBean> hackerrank;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       view= inflater.inflate(R.layout.fragment_hackerrank, container, false);
        ...
        model.getHackerRank(getActivity()).observe(getActivity(), new Observer<List<ContestBean>>() {
            @Override
            public void onChanged(List<ContestBean> contestBeans) {
                progress_bar.setVisibility(View.INVISIBLE);
                hackerrank= new ArrayList<ContestBean>(contestBeans);
                recyclerView.setLayoutManager(manager);
                adapter=new Adapter(contestBeans, HackerRank.this);
    ...
    public void onItemClicked(int position) {
        ...
        ContestBean obj=hackerrank.get(position);
