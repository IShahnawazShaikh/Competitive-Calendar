...
public class Leetcode extends Fragment implements RecyclerViewInterFace {
    View view;
    RecyclerView recyclerView;
    LinearLayoutManager manager;
    Adapter adapter;
    List<ContestBean> leetcode;
   ...
   SwipeRefreshLayout refresh;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view=inflater.inflate(R.layout.fragment_leetcode, container, false);
        recyclerView=(RecyclerView) view.findViewById(R.id.leetcode_recycle);
        ...
        model.getLeetcode(getActivity()).observe(getActivity(), new Observer<List<ContestBean>>() {
            @Override
            public void onChanged(List<ContestBean> contestBeans) {
                progress_bar.setVisibility(View.INVISIBLE);
                leetcode= new ArrayList<ContestBean>(contestBeans);
                recyclerView.setLayoutManager(manager);
                adapter=new Adapter(contestBeans, Leetcode.this);
    ...
    public void onItemClicked(int position) {
        ...
        ContestBean obj=leetcode.get(position);
